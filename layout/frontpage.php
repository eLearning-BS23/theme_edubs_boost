...
/**
 * A two column layout for the edubs theme.
 *
 * @package   theme_edubs
...
$extraclasses = [];
$frontpagenavdrawer = theme_edubs_get_setting('displaynavdrawerfp');
...
$teammember = theme_edubs_get_setting('teammemberno');
if ($teammember == 1) {
...
$logos = theme_edubs_get_setting('logosperrow');
if ($logos == 1) {
...
$isslider = false;
if (theme_edubs_get_setting('sliderenabled', true) == true || theme_edubs_get_setting('fpblock11', true) == true || theme_edubs_get_setting('fpblock12', true) == true || theme_edubs_get_setting('fpblock13', true) == true || theme_edubs_get_setting('FPLogos', true) == true || theme_edubs_get_setting('FPTeam', true) == true) {
    $isslider = true;
}
...
for ($i = 1; $i <= $elements; $i++) {
    ${"slotblock". $i} = theme_edubs_get_setting("slotblock" . $i);
}

$showfpblock1hr = theme_edubs_get_setting('showfpblock1hr');
$showfpblock2hr = theme_edubs_get_setting('showfpblock2hr');
$showfpblock4hr = theme_edubs_get_setting('showfpblock4hr');
$showfpblock6hr = theme_edubs_get_setting('showfpblock6hr');
$showfpblock7hr = theme_edubs_get_setting('showfpblock7hr');
$showfpblock8hr = theme_edubs_get_setting('showfpblock8hr');
$showfpblock10hr = theme_edubs_get_setting('showfpblock10hr');
$showfpblock11hr = theme_edubs_get_setting('showfpblock11hr');
$showfpblock12hr = theme_edubs_get_setting('showfpblock12hr');
$showfpblockteamhr = theme_edubs_get_setting('showfpblockteamhr');
