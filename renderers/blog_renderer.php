...
//
//class theme_edubs_core_blog_renderer extends core_blog_renderer {
//
//    /**
...
//									<li><span>'. $entry->renderable->comment->count() .' '.get_string('comments', 'theme_edubs').'</span></li>';
//            }
//            $o .='
//								</ul>
...
//								<li><p>'.get_string('share', 'theme_edubs').'</p></li>
...
//                  <h4 class="aii_title">'.get_string('reviews', 'theme_edubs').'</h4>'. $ccn_comments->output(true) .'
//                </div>
//              </div>';
//            }
//            $o .='</div>';
